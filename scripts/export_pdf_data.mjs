...
process.stdout.write(JSON.stringify({
  ...
  redesign: {
    ...
    testedRollRange: REDESIGN_STUDY.testedRollRange,
    sampledPairTests: REDESIGN_STUDY.sampledPairTests,
    sampledRollStartDegrees: REDESIGN_STUDY.sampledRollStartDegrees,
    sampledRollEndDegrees: REDESIGN_STUDY.sampledRollEndDegrees,
    sampledRollIncrementDegrees: REDESIGN_STUDY.sampledRollIncrementDegrees,
    sampledRollPositionCount: REDESIGN_STUDY.sampledRollPositionCount,
    ...
    externalMemberEnvelopeLengthInches: REDESIGN_STUDY.externalMemberEnvelopeLengthInches,
